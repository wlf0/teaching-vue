  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: '/testEcharts', name: 'testEcharts', component: () => import('../views/testEcharts.vue')},
    ...
    },
    {
      path: '/model3d',
      name: 'model3d',
      component: () => import('../views/Model3D2.vue')
    },
    {
      path: '/modelshow',
      name: 'ModelShow',
...
router.beforeEach((to, from, next) => {
  ...
  const noPermissionPaths = ['/login', '/404','/modelshow']   // 定义无需登录的路由
